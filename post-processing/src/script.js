...
const texturedPass = new ShaderPass(TexturedShader);
texturedPass.material.uniforms.uNormalMap.value = textureLoader.load(
  "/textures/interfaceNormalMap.png"
);
effectComposer.addPass(texturedPass);
...
tintPass.material.uniforms.uTint.value = new THREE.Vector3(0.0);
